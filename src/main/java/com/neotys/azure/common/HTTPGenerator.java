...
import static com.neotys.azure.common.HTTPGeneratorUtils.*;
...
public class HTTPGenerator {
	...
	public JSONArray executeAndGetJsonArrayResponse() throws IOException,  AzureException {
		...
		if (!HttpResponseUtils.isSuccessHttpCode(httpResponse.getStatusLine().getStatusCode())) {
			...
			throw new AzureException(httpResponse.getStatusLine().getReasonPhrase() + " - "+ request + " - " + stringResponse);
		}
